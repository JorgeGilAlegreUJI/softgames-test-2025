...
export const anonymousAsset = 'anonymous.png';
export const flamesAsset = 'flames.png';
export const explosionAsset = 'explosion.png';
export const clickSoundAsset = 'preload/click.wav';
export const songSoundAsset = 'preload/song.wav';
